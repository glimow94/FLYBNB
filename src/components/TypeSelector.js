...
/*   changeCheck=()=>{
  ...
  render() {
    ...
    return (
      <View>
        {this.props.searchBarText.length != 0?<FilterButton text="Struttura" onPress={this.showHide} backgroundColor={colors.white} borderColor={colors.secondary} ></FilterButton>:<FilterButton text="Struttura" backgroundColor={colors.white} borderColor={colors.secondary} opacity={0.2}></FilterButton>}
